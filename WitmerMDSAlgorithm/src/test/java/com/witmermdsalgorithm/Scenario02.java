...
public class Scenario02 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		for (int i = 1; i <= 22; i++) {
			...
			WebElement option1 = MDS_Question_Option.option1(driver); WebElement option3 = MDS_Question_Option.option3(driver);
			WebElement option4 = MDS_Question_Option.option4(driver); WebElement option5 = MDS_Question_Option.option5(driver);
			...
			if (questionText.contains(question02) || questionText.contains(question01) ||
				...
				questionText.contains(question05) || questionText.contains(question08) ||
				questionText.contains(question09) || questionText.contains(question10) ||
				questionText.contains(question11) || questionText.contains(question16) ||
				questionText.contains(question17) || questionText.contains(question19) ||
				questionText.contains(question20) || questionText.contains(question21) ||
				questionText.contains(question13)) {

				option1.click(); Thread.sleep(500);
				
			} else if (questionText.contains(question06) || questionText.contains(question18)) {

				option5.click(); Thread.sleep(500);
				
			} else if (questionText.contains(question07) || questionText.contains(question12)) {

				option4.click(); Thread.sleep(500);
				
			} else if (questionText.contains(question14) || questionText.contains(question15)) {
		...
		System.out.println("The Result of MDS Algorithm Scenario02 are listed below:");
		...
		String expectedtext02 = "Lower anxiety";
		...
		String expectedtext03 = "Addictions";
		...
		if(pagecontent03.contains("Anxiety")) {
		...
		if(pagecontent03.contains(expectedtext03)) {
		...
		String page04resultvalue = "Mood and Emotions 25/90\r\n"
				+ "DEPRESSION 04/20\r\n"
				+ "ANXIETY 10/15\r\n"
				+ "STRESS 03/15\r\n"
		...
		String REC_Depression = "Depression\r\n"
				+ "You are doing well, and your positive mood is a source of strength. Continue to maintain a positive\r\n"
				+ "mood by using the tools on this portal. \r\n"
				+ "4/20";
		...
		//Anxiety will not be correct because the pdfstr is not fecthing correctly
		String REC_Anxiety = "Anxiety\r\n"
				+ "You are finding it tough and must seek professional help. As a next step, you may take a specific\r\n"
				+ "screener for anxiety. This screener is available on the anxiety page of this portal.\r\n"
				+ "10/15";
		...
		String REC_Cognitive_Skills = "Cognitive Skills\r\n"

	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		for (int i = 1; i <= 22; i++) {
			...
			if (questionText.contains(question02) || questionText.contains(question01) ||
				...
				questionText.contains(question11) || questionText.contains(question15) ||
				...
				option1.click(); Thread.sleep(500);
					   ...
					   questionText.contains(question12) || questionText.contains(question14) ||
					   questionText.contains(question16)) {
			...
			} else if (questionText.contains(question17) || questionText.contains(question18)) {
		...
		System.out.println("The Result of MDS Algorithm Scenario03 are listed below:");
		...
		String expectedtext02 = "Stress less";
		...
		String expectedtext03 = "Lower anxiety";
		...
		String page04resultvalue = "Mood and Emotions 34/90\r\n"
				+ "DEPRESSION 04/20\r\n"
				+ "ANXIETY 11/15\r\n"
				+ "STRESS 11/15\r\n"

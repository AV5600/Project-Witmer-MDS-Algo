...
public class Scenario04 {
	...
	public Scenario04(WebDriver driver) {
		this.driver = driver;
	}
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		for (int i = 1; i <= 22; i++) {
			...
			if (questionText.contains(question02) || questionText.contains(question01) ||
				...
				questionText.contains(question15) || questionText.contains(question19) ||
		...
		System.out.println("The Result of MDS Algorithm Scenario04 are listed below:");

	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		for (int i = 1; i <= 22; i++) {
			...
			if (questionText.contains(question02) || questionText.contains(question01) ||
				...
				questionText.contains(question05) || questionText.contains(question15) ||
				...
				option1.click(); Thread.sleep(500);
					 ...
					 questionText.contains(question18)) {
		...
		for (int i = 1; i <= 32; i++) {
			...
			if (questionText.contains(question23) || questionText.contains(question24) ||
				questionText.contains(question29) || questionText.contains(question41) ||
		...
		System.out.println("The Result of MDS Algorithm Scenario06 are listed below:");
		...
		String expectedtext02 = "Manage mood";
		...
		String page04resultvalue = "Mood and Emotions 58/90\r\n"
				+ "DEPRESSION 20/20\r\n"
				+ "ANXIETY 11/15\r\n"
				+ "STRESS 11/15\r\n"
